...
class SceneManager:
    ...
    def switch(self, scene: str):
        ...
        self.bridge.groups[self.group].action(scene=sid, transitiontime=10 * self.delay)
...
class TimeTrackingSceneManager(SceneManager):
    ...
    def __init__(
        self,
        times: Sequence[Union[str, Sequence[str]]],
        ...
        **kwargs,
        ...
        self.times = [
            [self._assert_scene(scene) for scene in seq] for seq in normalized_times
        ]
